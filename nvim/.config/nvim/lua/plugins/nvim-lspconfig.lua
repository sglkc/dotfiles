...
local servers = {
  --[[ 'bashls', 'pyright', 'clangd', 'html', 'cssls', ]]--
  -- phpactor intelephense emmet_ls unocss
  'pyright', 'clangd', -- 'tsserver',-- 'jdtls', -- 'jedi_language_server'
  'astro', 'html', 'cssls', 'dartls', 'intelephense', 'vtsls',
  'gopls', --'emmet_language_server',
}
...
--   init_options = {
--     typescript = {
--       tsdk = '/home/sglkc/.nvm/versions/node/v18.15.0/lib/node_modules/typescript/lib'
--     }
--   },
--   settings = {
--     css = {
