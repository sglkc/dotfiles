return {
  -- Native Neovim 0.11+ LSP configuration using vim.lsp.config and vim.lsp.enable
  -- No external dependencies required for basic LSP functionality
  {
    "hrsh7th/cmp-nvim-lsp", -- Only needed for enhanced completion capabilities
    lazy = false,
    config = function()
      ...
      local servers = {
        'basedpyright', 'clangd', 'gopls', 'svelte',
